...
public class class54 {
	...
	static int method1101(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_GETINVOBJECT) { // L: 1186
			Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = var3.item; // L: 1187
			return 1; // L: 1188
		} else if (var0 == ScriptOpcodes.CC_GETINVCOUNT) { // L: 1190
			if (var3.item != -1) { // L: 1191
			...
			Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = var3.slot; // L: 1196
			return 1; // L: 1197
		} else {
			return 2; // L: 1199
		}
