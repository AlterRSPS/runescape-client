...
public class InvDefinition extends DualNode {
	...
	public static void method2986(int var0, int var1, int var2, boolean var3) {
		PacketBufferNode var4 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.TELEPORT, Client.packetWriter.isaacCipher); // L: 12003
		var4.packetBuffer.writeShortAdd(var0); // X
		var4.packetBuffer.writeShortAdd(var1); // Y
		var4.packetBuffer.wirteByteNeg(var2); // HEIGHT
		var4.packetBuffer.N_writeIntIME(var3 ? Client.field552 * -2052313535 * -1777671743 : 0); // unknown
