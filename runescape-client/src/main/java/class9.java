...
public class class9 implements MouseWheel {
	...
	static final void method82(String var0) {
		PacketBufferNode var1 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IGNORELIST_ADD, Client.packetWriter.isaacCipher); // L: 181
		var1.packetBuffer.writeByte(Client.stringCp1252NullTerminatedByteSize(var0)); // L: 182
		var1.packetBuffer.sendStringByBytes(var0); // L: 183
