		...
		if (var5 != null) { // L: 9157
			...
			if (var11) { // L: 9168
				...
				if (var7) { // L: 9175
					...
					if (var0 == 1) { // L: 9178
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON1, Client.packetWriter.isaacCipher); // L: 9180
					...
					if (var0 == 2) { // L: 9186
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON2, Client.packetWriter.isaacCipher); // L: 9188
					...
					if (var0 == 3) { // L: 9194
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON3, Client.packetWriter.isaacCipher); // L: 9196
					...
					if (var0 == 4) { // L: 9202
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON4, Client.packetWriter.isaacCipher); // L: 9204
					...
					if (var0 == 5) { // L: 9210
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON5, Client.packetWriter.isaacCipher); // L: 9212
					...
					if (var0 == 6) { // L: 9218
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON6, Client.packetWriter.isaacCipher); // L: 9220
					...
					if (var0 == 7) { // L: 9226
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON7, Client.packetWriter.isaacCipher); // L: 9228
					...
					if (var0 == 8) { // L: 9234
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON8, Client.packetWriter.isaacCipher); // L: 9236
					...
					if (var0 == 9) { // L: 9242
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON9, Client.packetWriter.isaacCipher); // L: 9244
					...
					if (var0 == 10) { // L: 9250
						var10 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.IF_BUTTON10, Client.packetWriter.isaacCipher); // L: 9252
