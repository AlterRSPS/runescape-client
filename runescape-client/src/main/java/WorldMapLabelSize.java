		...
		if (var0 == ScriptOpcodes.CC_CREATE) { // L: 483
			...
			if (var4 == 0) { // L: 488
				...
				if (var11 > 0 && var6.children[var11 - 1] == null) { // L: 498
					...
					var12.parentId = var12.hash = var6.hash; // L: 501
					var12.slot = var11; // L: 502
			...
			if (var0 == ScriptOpcodes.CC_DELETE) { // L: 510
				...
				Widget var10 = UserComparator9.getWidget(var3.hash); // L: 512
				var10.children[var3.slot] = null; // L: 513
