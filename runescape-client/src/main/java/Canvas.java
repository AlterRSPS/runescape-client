...
public final class Canvas extends java.awt.Canvas {
	...
	static final void loadRegions(boolean var0, PacketBuffer var1) {
		...
		if (!Client.isInInstance) { // L: 5701
			var2 = var1.readUShortAdd(); // Y
			var3 = var1.readUShortLE(); // X
			int var4 = var1.readUnsignedShort(); // Size
			...
			boolean var15 = var1.readUnsignedByte() == 1; // Force
			var5 = var1.readUnsignedShort(); // DATA_SIZE
