	...
	static final void method3267(int var0, int var1) {
		...
		if (var2 != null && var1 >= 0 && var1 < var2.method2809()) { // L: 11829
			...
			if (var3.rank == -1) {
				...
				PacketBufferNode var6 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.CLANCHANNEL_KICKUSER, var5.isaacCipher); // L: 11834
				...
				var6.packetBuffer.sendStringByBytes(var4); // L: 11838
