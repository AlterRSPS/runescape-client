...
public class class1 implements Callable {
	...
	static final int method15(long var0, String var2) {
		...
		var8.sendStringByBytes(var2); // L: 104
		...
		if (Client.minimapState == 0 || Client.minimapState == 3) { // L: 4115
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !ApproximateRouteStrategy.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) { // L: 4116
				...
				if (var3.contains(var4, var5)) { // L: 4121
					...
					PacketBufferNode var13 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.MOVE_MINIMAPCLICK, Client.packetWriter.isaacCipher); // L: 4132
					var13.packetBuffer.writeByte(18); // L: 4133
					var13.packetBuffer.writeShortAdd(var11 + class19.baseX); // L: 4134
					var13.packetBuffer.wirteByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0); // L: 4135
