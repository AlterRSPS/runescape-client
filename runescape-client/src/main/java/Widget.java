...
public class Widget extends Node {
	...
	void decodeLegacy(Buffer var1) {
		...
		if (this.parentId == 65535) { // L: 250
			...
			this.parentId += this.hash & -65536; // L: 251
		}
		...
		if (this.type == 2) { // L: 283
			...
			for (var8 = 0; var8 < 5; ++var8) { // L: 309
				String var9 = var1.readString(); // L: 310
		...
		if (this.type == 4) { // L: 328
			this.text = var1.readString(); // L: 329
			this.text2 = var1.readString(); // L: 330
		}
		...
		if (this.type == 7) { // L: 357
			...
			for (var5 = 0; var5 < 5; ++var5) { // L: 370
				String var10 = var1.readString(); // L: 371
		...
		if (this.type == 8) { // L: 378
			this.text = var1.readString(); // L: 379
		}

		if (this.buttonType == 2 || this.type == 2) { // L: 381
			this.spellActionName = var1.readString(); // L: 382
			this.spellName = var1.readString(); // L: 383
		...
		if (this.buttonType == 1 || this.buttonType == 4 || this.buttonType == 5 || this.buttonType == 6) { // L: 387
			this.buttonText = var1.readString(); // L: 388
	...
	void decode(Buffer var1) {
		...
		if (this.parentId == 65535) { // L: 419
			...
			this.parentId += this.hash & -65536; // L: 420
		}
		...
		if (this.type == 4) { // L: 456
			...
			this.text = var1.readString(); // L: 459
		...
		this.dataText = var1.readString(); // L: 477
		...
		this.spellActionName = var1.readString(); // L: 486
