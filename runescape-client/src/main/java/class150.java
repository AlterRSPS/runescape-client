		...
		for (int var2 = 0; var2 < var0.length; ++var2) { // L: 11126
			...
			if (var3 != null) { // L: 11128
				if (var3.type == 0) { // L: 11129
					...
					InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get((long)var3.hash); // L: 11131
				...
				if (var1 == 1 && var3.onSubChange != null) { // L: 11140
					if (var3.slot >= 0) { // L: 11141
						Widget var6 = UserComparator9.getWidget(var3.hash); // L: 11142
						if (var6 == null || var6.children == null || var3.slot >= var6.children.length || var3 != var6.children[var3.slot]) { // L: 11143
							continue;
						}
					}
