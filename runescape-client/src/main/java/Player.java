...
public final class Player extends Actor {
	...
	final void read(Buffer var1) {
		...
		this.username = new Username(var1.readString(), GrandExchangeOfferUnitPriceComparator.loginType); // L: 102
	...
	static final void clanKickUser(String var0) {
		if (AbstractArchive.friendsChat != null) { // L: 11804
			PacketBufferNode var1 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.CLAN_KICKUSER, Client.packetWriter.isaacCipher); // L: 11805
			var1.packetBuffer.writeByte(Client.stringCp1252NullTerminatedByteSize(var0)); // L: 11806
			var1.packetBuffer.sendStringByBytes(var0); // L: 11807
