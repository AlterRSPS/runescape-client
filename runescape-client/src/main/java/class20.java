		...
		if (Client.currentClanChannels[var0] != null) { // L: 11843
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method2809()) { // L: 11844
				...
				if (var2.rank == -1) { // L: 11846
					...
					PacketBufferNode var4 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.AFFINEDCLANSETTINGS_ADDBANNED_FROMCHANNEL, var3.isaacCipher); // L: 11848
					...
					var4.packetBuffer.sendStringByBytes(var2.username.getName()); // L: 11852
