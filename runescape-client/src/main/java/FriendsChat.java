...
public class FriendsChat extends UserList {
	...
	public final void readUpdate(Buffer var1) {
		this.setOwner(var1.readString()); // L: 41
		...
		if (var7 != 255) { // L: 71
			...
			for (int var13 = 0; var13 < var7; ++var13) { // L: 73
				ClanMate var9 = (ClanMate)this.addLastNoPreviousUsername(new Username(var1.readString(), this.loginType)); // L: 74
				int var14 = var1.readUnsignedShort(); // L: 75
				var9.set(var14, ++this.field3939 - 1); // L: 76
				var9.rank = var1.readByte(); // L: 77
				var1.readString(); // L: 78
	...
	public final void method6040(Buffer var1) {
		Username var2 = new Username(var1.readString(), this.loginType); // L: 84
