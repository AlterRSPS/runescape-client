...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static final void Clan_joinChat(String var0) {
		if (!var0.equals("")) { // L: 11812
			PacketBufferNode var1 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.CLAN_JOINCHAT_LEAVECHAT, Client.packetWriter.isaacCipher); // L: 11814
			var1.packetBuffer.writeByte(Client.stringCp1252NullTerminatedByteSize(var0)); // L: 11815
			var1.packetBuffer.sendStringByBytes(var0); // L: 11816
