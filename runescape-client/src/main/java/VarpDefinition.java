	...
	static final void method3003(int var0, int var1, boolean var2) {
		if (Client.currentClanChannels[var0] != null) { // L: 11857
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method2809()) { // L: 11858
				...
				PacketBufferNode var5 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.AFFINEDCLANSETTINGS_SETMUTED_FROMCHANNEL, var4.isaacCipher); // L: 11861
				...
				var5.packetBuffer.sendStringByBytes(var3.username.getName()); // L: 11866
