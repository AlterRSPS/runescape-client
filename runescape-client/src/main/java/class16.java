...
public class class16 implements ThreadFactory {
					...
					try {
						...
						if (var4 != 3) { // L: 57
							...
							if (var11 == null) { // L: 66
								...
								var0.sendStringByBytes((String)var11); // L: 73
							} else {
	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		for (var2 = 0; var2 < Client.field512; ++var2) { // L: 7854
				...
				if (var7 > 0) { // L: 7886
					for (var8 = 0; var8 < var7; ++var8) { // L: 7887
						...
						if (var15 != 32767) { // L: 7890
							...
							int var13 = var15 > 0 ? var1.readUByteAdd() : var12; // L: 7893
			...
			if ((var5 & 2) != 0) { // L: 7903
				var4.definition = ScriptFrame.getNpcDefinition(var1.readUShortAdd()); // L: 7904
			...
			if ((var5 & 16) != 0) { // L: 7915
				var4.targetIndex = var1.readUShortLE(); // L: 7916
			...
			if ((var5 & 1) != 0) { // L: 7919
				var6 = var1.readShortAddLE(); // L: 7920
				var7 = var1.readShortAddLE(); // L: 7921
				if (Players.field1254) { // L: 7922
					var4.field1127 = var1.readUByteAdd() == 1; // L: 7923
				}
			...
			if (Players.field1254 && (var5 & 256) != 0 || !Players.field1254 && (var5 & 128) != 0) { // L: 7929
				var4.field1083 = var1.readByteSub(); // L: 7930
				var4.field1100 = var1.readByteAdd(); // L: 7931
				var4.field1128 = var1.readByteSub(); // L: 7932
				var4.field1130 = var1.readByteNeg(); // L: 7933
				var4.field1131 = var1.readUShortAdd() + Client.cycle; // L: 7934
				var4.field1132 = var1.readUnsignedShort() + Client.cycle; // L: 7935
				var4.field1133 = var1.readUShortLE(); // L: 7936
			...
			if ((var5 & 8) != 0) { // L: 7980
				var4.overheadText = var1.readString(); // L: 7981
