...
public class class92 {
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.RESUME_PAUSEBUTTON, Client.packetWriter.isaacCipher); // L: 9149
		var2.packetBuffer.N_writeIntLE(var0); // L: 9150
