...
public class ClanChannel extends Node {
	...
	void method2806(Buffer var1) {
		...
		this.name = var1.readString(); // L: 75
		...
		if (var4 > 0) { // L: 80
			...
			for (int var5 = 0; var5 < var4; ++var5) { // L: 82
				...
				if (this.field1518) { // L: 87
					var6.username = new Username(var1.readString());
				}
			...
			if (var9 != null && var9.parentId == var1 && (!var9.isIf3 || var9.type == 0 || var9.hasListener || PendingSpawn.getWidgetFlags(var9) != 0 || var9 == Client.clickedWidgetParent || var9.contentType == 1338)) { // L: 10630 10631 10632
				...
				if (var9.field3125) { // L: 10687
					...
					default:
						break;
					case 2:
						if (Client.field633 == var9.hash >>> 16) { // L: 10698
							var33 = true; // L: 10699
						}
						break;
					case 3:
						if (var9.hash == Client.field633) { // L: 10690
							var33 = true; // L: 10691
						}
					}
				}
					...
					if (var9.contentType == 1337) { // L: 10740
						...
						if (var33) { // L: 10759
							for (int var20 = 0; var20 < var9.field3180.length; ++var20) { // L: 10760
								...
								if (var27) { // L: 10785
									if (var20 < 10) { // L: 10786
										GrandExchangeEvents.widgetDefaultMenuAction(var20 + 1, var9.hash, var9.slot, var9.item, "");
									} else if (var20 == 10) { // L: 10787
										class262.Widget_runOnTargetLeave(); // L: 10788
										Decimator.selectSpell(var9.hash, var9.slot, SecureRandomCallable.Widget_unpackTargetMask(PendingSpawn.getWidgetFlags(var9)), var9.item); // L: 10789
						...
						if (var9.isIf3) { // L: 10808
							...
							if (Client.source != null && var9 != Client.source && var34 && PlayerComposition.method5067(PendingSpawn.getWidgetFlags(var9))) { // L: 10819
								Client.destination = var9;
							}
							...
							if (var9.hasListener) { // L: 10825
								...
								if (Client.source != null || class247.dragInventoryWidget != null || Client.isMenuOpen) { // L: 10834
									var21 = false; // L: 10835
									var35 = false; // L: 10836
									var34 = false; // L: 10837
								}
						...
						if (!var9.isIf3) { // L: 11076
							if (Client.source != null || class247.dragInventoryWidget != null || Client.isMenuOpen) { // L: 11077
								continue;
							}
						...
						if (var9.type == 0) { // L: 11087
							updateInterface(var0, var9.hash, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY); // L: 11088
							if (var9.children != null) { // L: 11089
								updateInterface(var9.children, var9.hash, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY);
							}

							InterfaceParent var28 = (InterfaceParent)Client.interfaceParents.get((long)var9.hash); // L: 11090
