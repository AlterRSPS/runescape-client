...
public class class28 {
	...
	static final void drawInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var9 = 0; var9 < var0.length; ++var9) { // L: 9695
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.source)) { // L: 9697 9698
				int var11;
				if (var8 == -1) { // L: 9700
				...
				if (!var10.isIf3 || !Varcs.isComponentHidden(var10)) { // L: 9710
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) { // L: 9776
						...
						if (var10.type == 0) { // L: 9820
							...
							drawInterface(var0, var10.hash, var15, var16, var17, var18, var12 - var10.scrollX, var13 - var10.scrollY, var11); // L: 9826
							...
							InterfaceParent var30 = (InterfaceParent)Client.interfaceParents.get((long)var10.hash); // L: 9828
								...
								if (var10.type == 2) { // L: 9842
										...
										for (var21 = 0; var21 < var10.rawWidth; ++var21) { // L: 9845
											...
											if (var10.itemIds[var19] <= 0) { // L: 9852
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class247.dragInventoryWidget && var19 == Client.dragItemSlotSource) { // L: 9856
													SpritePixels var35;
													if (Client.isItemSelected == 1 && var19 == ReflectionCheck.clickedSlot && var10.hash == MouseHandler.component) { // L: 9858
									...
									if (var10.type == 4) { // L: 9937
										...
										if (var39 == null) { // L: 9939
											...
											if (var10.isIf3 && var10.item != -1) { // L: 9954
												ItemComposition var45 = TaskHandler.ItemDefinition_get(var10.item); // L: 9955
										...
										if (!var10.isIf3) { // L: 9969
											...
											if (var10.item != -1) { // L: 9976
												var40 = class117.getItemSprite(var10.item, var10.itemQuantity, var10.outline, var10.spriteShadow, var10.itemQuantityMode, false);
											} else {
										...
										if (var10.type == 6) { // L: 10006
											...
											var22 = 0; // L: 10012
											if (var10.item != -1) { // L: 10013
												var33 = TaskHandler.ItemDefinition_get(var10.item); // L: 10014
