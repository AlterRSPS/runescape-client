							...
							for (var13 = 1; var13 < var3.length; ++var13) { // L: 143
								if (var3[var13] instanceof Integer) { // L: 144
									...
									if (var14 == -2147483645) { // L: 148
										var14 = var0.widget != null ? var0.widget.hash * 851670683 * -830177389 : -1;
									}
									...
									if (var14 == -2147483643) { // L: 150
										var14 = var0.widget != null ? var0.widget.slot * 855382617 * -349073943 : -1;
									}

									if (var14 == -2147483642) { // L: 151
										var14 = var0.dragTarget != null ? var0.dragTarget.hash * 851670683 * -830177389 : -1;
									}

									if (var14 == -2147483641) { // L: 152
										var14 = var0.dragTarget != null ? var0.dragTarget.slot * 855382617 * -349073943 : -1;
									}
