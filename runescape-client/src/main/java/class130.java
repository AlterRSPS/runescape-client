...
public class class130 extends class116 {
	...
	public static ZoneUpdate[] method2748() {
		return new ZoneUpdate[]{ZoneUpdate.MAPPROJ_ANIM, ZoneUpdate.OBJ_COUNT, ZoneUpdate.LOC_ANIM, ZoneUpdate.OBJ_ADD, ZoneUpdate.LOC_DEL, ZoneUpdate.MAP_ANIM, ZoneUpdate.PREFETCH_GAMEOBJECTS, ZoneUpdate.AREA_SOUND, ZoneUpdate.OBJ_DEL, ZoneUpdate.LOC_ADD_CHANGE}; // L: 17
	}
