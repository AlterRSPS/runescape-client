...
class class11 implements TlsAuthentication {
	...
	static final void method107(String var0, int var1) {
		PacketBufferNode var2 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.FRIEND_SETRANK, Client.packetWriter.isaacCipher); // L: 242
		var2.packetBuffer.writeByte(Client.stringCp1252NullTerminatedByteSize(var0) + 1); // L: 243
		var2.packetBuffer.sendStringByBytes(var0); // L: 244
