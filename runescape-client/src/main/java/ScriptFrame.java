	...
	static int method1118(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) { // L: 1412
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var14 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.RESUME_P_COUNTDIALOG, Client.packetWriter.isaacCipher); // L: 1433
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					var12 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.RESUME_P_NAMEDIALOG, Client.packetWriter.isaacCipher); // L: 1441
					var12.packetBuffer.writeByte(var7.length() + 1); // L: 1442
					var12.packetBuffer.sendStringByBytes(var7); // L: 1443
					...
					var12 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.RESUME_P_STRINGDIALOG, Client.packetWriter.isaacCipher); // L: 1450
					var12.packetBuffer.writeByte(var7.length() + 1); // L: 1451
					var12.packetBuffer.sendStringByBytes(var7); // L: 1452
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var12 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.RESUME_P_OBJDIALOG, Client.packetWriter.isaacCipher); // L: 1501
						...
						if (var4.length() > 500) { // L: 1511
							...
							PacketBufferNode var6 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.BUG_REPORT, Client.packetWriter.isaacCipher); // L: 1513
							...
							var6.packetBuffer.sendStringByBytes(var5); // L: 1515
							var6.packetBuffer.writeByte(var10); // L: 1516
							var6.packetBuffer.sendStringByBytes(var4); // L: 1517
						...
						Client.field633 = var2 ? class120.scriptDotWidget.hash * 851670683 * -830177389 : Frames.scriptActiveWidget.hash * 851670683 * -830177389; // L: 1623
						return 1; // L: 1624
					} else {
						boolean var11;
