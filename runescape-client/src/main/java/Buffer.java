...
public class Buffer extends Node {
	...
	public void sendStringByBytes(String var1) {
	...
	public void wirteByteNeg(int var1) {
	...
	public void N_writeMediumLME(int var1) {
	...
	public void N_writeIntLE(int var1) {
	...
	@Export("writeIntME")
	public void N_writeIntIME(int var1) {
	...
	public void N_writeIntME(int var1) {
	...
	public void readAdditiveSliceReversed(byte[] var1, int start, int stop) {
		for (int dex = stop + start - 1; dex >= start; --dex) { // L: 652
			var1[dex] = this.array[++this.offset - 1];
		}
	...
	public void N_readBytesAdd(byte[] var1, int var2, int var3) {
		for (int var4 = var2; var4 < var3 + var2; ++var4) {
