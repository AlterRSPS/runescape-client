...
public class class7 {
	...
	static final void doCheat(String var0) {
		...
		PacketBufferNode var1 = AbstractWorldMapData.getPacketBufferNode(ClientPacket.CLIENT_CHEAT, Client.packetWriter.isaacCipher); // L: 4173
		var1.packetBuffer.writeByte(var0.length() + 1); // L: 4174
		var1.packetBuffer.sendStringByBytes(var0); // L: 4175
		System.out.println("Var0" + var0 + " var0length:");
