...
public class MouseRecorder implements Runnable {
	...
	static int method2089(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.IF_GETINVOBJECT) { // L: 1365
			...
			Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = var5.item; // L: 1367
			return 1; // L: 1368
	...
	static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean var2) {
		...
		WorldMapLabelSize.resizeInterface(var0, var1.hash, var3, var4, var2); // L: 10231
		if (var1.children != null) { // L: 10232
			WorldMapLabelSize.resizeInterface(var1.children, var1.hash, var3, var4, var2);
		}

		InterfaceParent var5 = (InterfaceParent)Client.interfaceParents.get((long)var1.hash); // L: 10233
		if (var5 != null) {
